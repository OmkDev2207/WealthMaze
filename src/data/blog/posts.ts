...
export const blogPosts: BlogPost[] = [
  {
    ...
    description: "The annual fee a mutual fund charges you — silently deducted from returns. A 1% expense ratio on a $100,000 portfolio costs you $1,000 every year.",
    publishedAt: "June 28, 2026",
    readTime: "1 min read",
    category: "Finance in 60 Seconds",
    tags: ["Expense Ratio", "What is Expense Ratio", "Mutual Fund Fees", "Investing Basics", "Finance in 60 Seconds"],
    author: authors.omk,
    relatedCalculators: ["mutual-fund-return-calculator"],
  },
  {
    slug: "what-is-dollar-cost-averaging",
    title: "What is Dollar Cost Averaging?",
    description: "Investing a fixed amount at regular intervals regardless of market conditions. When prices fall you buy more units. When prices rise you buy fewer.",
    publishedAt: "June 28, 2026",
    readTime: "1 min read",
    category: "Finance in 60 Seconds",
    tags: ["Dollar Cost Averaging", "What is DCA", "SIP Investing", "Market Volatility Strategy", "Finance in 60 Seconds"],
    author: authors.omk,
  ...
  },
  {
    ...
    description: "A market decline of 20% or more from recent highs. Bear markets are normal — the S&P 500 has experienced 26 bear markets since 1928.",
    publishedAt: "June 28, 2026",
    readTime: "1 min read",
    category: "Finance in 60 Seconds",
    tags: ["Bear Market", "What is a Bear Market", "Stock Market Crash", "Investing Psychology", "Finance in 60 Seconds"],
    author: authors.omk,
  ...
  },
  {
    ...
    description: "A sustained rise of 20% or more in market prices. The average bull market lasts 2.7 years and produces gains of approximately 114%.",
    publishedAt: "June 28, 2026",
    readTime: "1 min read",
    category: "Finance in 60 Seconds",
    tags: ["Bull Market", "What is a Bull Market", "Stock Market Rally", "Wealth Building", "Finance in 60 Seconds"],
    author: authors.omk,
  ...
  },
  {
    ...
    description: "Earning interest on your interest. Over 30 years it turns $1,000 into $17,449 at 10% annual return.",
    publishedAt: "June 28, 2026",
    readTime: "1 min read",
    category: "Finance in 60 Seconds",
    tags: ["Compound Interest", "What is Compound Interest", "Compounding Power", "Long Term Investing", "Finance in 60 Seconds"],
    author: authors.omk,
    relatedCalculators: ["compound-interest-calculator"],
  },
  {
    slug: "what-is-an-index-fund-60s",
    title: "What is an Index Fund?",
    description: "A fund that tracks a market index — like the S&P 500 — by holding all the stocks in that index in proportion to their size. No fund manager picking stocks.",
    publishedAt: "June 28, 2026",
    readTime: "1 min read",
    category: "Finance in 60 Seconds",
    tags: ["Index Fund", "What is an Index Fund", "Passive Investing", "S&P 500 Index", "Finance in 60 Seconds"],
    author: authors.omk,
    relatedCalculators: ["sip-calculator"],
  },
  {
    ...
    description: "The rate at which prices rise over time — reducing purchasing power. At 5% annual inflation, $100 today buys only $61 worth of goods in 10 years.",
    publishedAt: "June 28, 2026",
    readTime: "1 min read",
    category: "Finance in 60 Seconds",
    tags: ["Inflation", "What is Inflation", "Purchasing Power Loss", "Personal Finance Basics", "Finance in 60 Seconds"],
    author: authors.omk,
    relatedCalculators: ["inflation-calculator"],
  },
  {
    slug: "what-is-a-dividend-60s",
    title: "What is a Dividend?",
    description: "A portion of a company's profits paid directly to shareholders — usually quarterly. If you own 100 shares paying a $2 dividend, you receive $200 per year.",
    publishedAt: "June 28, 2026",
    readTime: "1 min read",
    category: "Finance in 60 Seconds",
    tags: ["Dividend", "What is a Dividend", "Dividend Yield", "Passive Income Stocks", "Finance in 60 Seconds"],
    author: authors.omk,
    relatedCalculators: ["portfolio-return-calculator"],
  },
  {
    slug: "what-is-asset-allocation-60s",
    title: "What is Asset Allocation?",
    description: "How you divide your portfolio across different asset classes — stocks, bonds, gold, cash. The mix determines both your risk level and expected return.",
    publishedAt: "June 28, 2026",
    readTime: "1 min read",
    category: "Finance in 60 Seconds",
    tags: ["Asset Allocation", "What is Asset Allocation", "Portfolio Diversification", "Risk Management Strategy", "Finance in 60 Seconds"],
    author: authors.omk,
    relatedCalculators: ["net-worth-calculator"],
  },
  {
    slug: "what-is-a-mutual-fund-60s",
    title: "What is a Mutual Fund?",
    description: "A pooled investment vehicle where thousands of investors contribute money that a professional fund manager invests collectively.",
    publishedAt: "June 28, 2026",
    readTime: "1 min read",
    category: "Finance in 60 Seconds",
    tags: ["Mutual Fund", "What is a Mutual Fund", "SIP Investment", "Pooled Investing", "Finance in 60 Seconds"],
    author: authors.omk,
    relatedCalculators: ["mutual-fund-return-calculator"],
  },
  {
    slug: "what-is-cagr-60s",
    title: "What is CAGR?",
    description: "Compound Annual Growth Rate — the smoothed annual return of an investment over a period. It tells you the equivalent steady annual return.",
    publishedAt: "June 28, 2026",
    readTime: "1 min read",
    category: "Finance in 60 Seconds",
    tags: ["CAGR", "What is CAGR", "Compound Annual Growth Rate", "Return Calculation", "Finance in 60 Seconds"],
    author: authors.omk,
    relatedCalculators: ["cagr-calculator"],
  },
  {
    slug: "what-is-net-worth-60s",
    title: "What is Net Worth?",
    description: "Everything you own minus everything you owe. Assets minus liabilities. A true snapshot of financial health.",
    publishedAt: "June 28, 2026",
    readTime: "1 min read",
    category: "Finance in 60 Seconds",
    tags: ["Net Worth", "What is Net Worth", "Assets vs Liabilities", "Financial Wealth Tracking", "Finance in 60 Seconds"],
    author: authors.omk,
    relatedCalculators: ["net-worth-calculator"],
  },
  {
    slug: "what-is-a-recession-60s",
    title: "What is a Recession?",
    description: "Two consecutive quarters of negative GDP growth. Recessions cause unemployment to rise and corporate profits to fall. Average duration: 11 months.",
    publishedAt: "June 28, 2026",
    readTime: "1 min read",
    category: "Finance in 60 Seconds",
    tags: ["Recession", "What is a Recession", "Economic Downturn", "Market Cycles", "Finance in 60 Seconds"],
    author: authors.omk,
    relatedCalculators: ["financial-freedom-calculator"],
  },
  {
    slug: "what-is-liquidity-60s",
    title: "What is Liquidity?",
    description: "How quickly and easily an asset can be converted to cash without losing significant value. Cash is perfectly liquid; real estate is illiquid.",
    publishedAt: "June 28, 2026",
    readTime: "1 min read",
    category: "Finance in 60 Seconds",
    tags: ["Liquidity", "What is Liquidity", "Liquid Assets vs Illiquid", "Emergency Cash Buffer", "Finance in 60 Seconds"],
    author: authors.omk,
    relatedCalculators: ["net-worth-calculator"],
  },
  {
    slug: "what-is-a-bond-60s",
    title: "What is a Bond?",
    description: "A loan you make to a government or company. They pay you fixed interest for a set period then return your principal at maturity.",
    publishedAt: "June 28, 2026",
    readTime: "1 min read",
    category: "Finance in 60 Seconds",
    tags: ["Bonds", "What is a Bond", "Fixed Income Investing", "Government Bonds", "Asset Allocation", "Finance in 60 Seconds"],
    author: authors.omk,
    relatedCalculators: ["cagr-calculator"],
  },
  {
    slug: "what-is-rebalancing-60s",
    title: "What is Rebalancing?",
    description: "Periodically restoring your portfolio to its target asset allocation. Rebalancing means selling high and buying low automatically to maintain your risk-reward balance.",
    publishedAt: "June 28, 2026",
    readTime: "1 min read",
    category: "Finance in 60 Seconds",
    tags: ["Portfolio Rebalancing", "Asset Allocation", "What is Rebalancing", "Risk Management", "Investing Strategy", "Finance in 60 Seconds"],
    author: authors.omk,
    relatedCalculators: ["portfolio-return-calculator"],
  },
  {
    slug: "what-is-an-emergency-fund-60s",
    title: "What is an Emergency Fund?",
    description: "Three to six months of living expenses held in a liquid, accessible account. A financial safety buffer designed to protect your investments during emergencies.",
    publishedAt: "June 28, 2026",
    readTime: "1 min read",
    category: "Finance in 60 Seconds",
    tags: ["Emergency Fund", "What is Emergency Fund", "Personal Finance Basics", "Financial Buffer", "Savings Planning", "Finance in 60 Seconds"],
    author: authors.omk,
    relatedCalculators: ["savings-calculator"],
  },
  {
    slug: "what-is-pe-ratio-60s",
    title: "What is a P/E Ratio?",
    description: "Price-to-Earnings ratio — a stock's current price divided by its annual earnings per share. Learn how P/E ratio measures stock valuation and growth expectations.",
    publishedAt: "June 28, 2026",
    readTime: "1 min read",
    category: "Finance in 60 Seconds",
    tags: ["P/E Ratio", "Price to Earnings", "Stock Valuation", "Fundamental Analysis", "Stock Market Basics", "Finance in 60 Seconds"],
    author: authors.omk,
    relatedCalculators: ["cagr-calculator"],
  },
  {
    slug: "what-is-rupee-cost-averaging-60s",
    title: "What is Rupee Cost Averaging?",
    description: "The Indian equivalent of Dollar Cost Averaging — investing a fixed rupee amount regularly regardless of market conditions. Learn how SIP automates buying the dip.",
    publishedAt: "June 28, 2026",
    readTime: "1 min read",
    category: "Finance in 60 Seconds",
    tags: ["Rupee Cost Averaging", "SIP Investing", "Mutual Fund SIP", "Dollar Cost Averaging", "Systematic Investing", "Finance in 60 Seconds"],
    author: authors.omk,
    relatedCalculators: ["sip-calculator"],
  },
  {
    slug: "what-is-the-4-percent-rule-60s",
    title: "What is the 4% Rule?",
    description: "A retirement withdrawal guideline suggesting you can withdraw 4% of your portfolio annually without running out of money over a 30-year retirement.",
    publishedAt: "June 28, 2026",
    readTime: "1 min read",
    category: "Finance in 60 Seconds",
    tags: ["4% Rule", "Retirement Planning", "Safe Withdrawal Rate", "Financial Independence", "FIRE Movement", "Finance in 60 Seconds"],
    author: authors.omk,
    relatedCalculators: ["financial-freedom-calculator"],
  },
  {
