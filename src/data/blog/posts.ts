...
export const blogPosts: BlogPost[] = [
  ...
  {
    slug: "sip-vs-fd",
    title: "FD vs SIP: What They Actually Mean and Which One Builds Wealth",
    description: "FD and SIP aren't opposites — they serve different financial jobs. Here's what each instrument actually does, the risk nobody talks about honestly, and why the \"which is better\" debate misses the point.",
    publishedAt: "June 25, 2026",
    readTime: "10 min read",
    category: "Investing",
    tags: ["FD vs SIP", "Fixed Deposit", "SIP", "Mutual Funds", "Investing"],
    author: authors.omk,
    relatedCalculators: ["sip-calculator", "fd-calculator", "goal-planner", "cagr-calculator"],
  },
  {
    slug: "sip-mistakes",
