  ...
  return (
    ...
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-6">
      ...
      <section className="space-y-4 text-sm leading-relaxed text-zinc-600 dark:text-zinc-300">
        <p>
          At <strong>WealthMaze</strong> (accessible from wealthmaze.in), one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by WealthMaze and how we use it.
        </p>
        ...
        <p>
          Google, as a third-party vendor, uses cookies (known as DART cookies) to serve ads based upon visits to wealthmaze.in and other sites on the internet. Visitors may choose to decline DART cookies by visiting the Google ad and content network Privacy Policy at:{" "}
