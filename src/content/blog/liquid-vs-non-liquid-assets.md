...
*Evaluate your own liquidity and asset breakdown with WealthMaze's [Net Worth Calculator](/net-worth-calculator). Calculate your ideal 3-6 month safety net with the [Emergency Fund Calculator](/emergency-fund-calculator), and compare liquid returns using the [FD Calculator](/fd-calculator).*

---

## Sources & Further Reading

- [RBI — Financial Stability and Household Liquidity](https://www.rbi.org.in) — Reserve Bank data on household savings composition and liquidity patterns.
- [Investopedia — Liquidity Risk](https://www.investopedia.com/terms/l/liquidityrisk.asp) — Foundational overview of liquidity risk in personal and institutional finance.
