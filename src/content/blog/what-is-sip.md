...
| Month | Market Condition | NAV (₹) | Units Purchased |
|-------|-----------------|---------|----------------|
| Jan   | Bull run        | 120     | 83.3           |
| Feb   | Slowdown        | 100     | 100.0          |
| Mar   | Correction      | 80      | 125.0          |
| Apr   | Crash           | 60      | 166.7          |
| May   | Recovery begins | 75      | 133.3          |
| Jun   | Recovery        | 95      | 105.3          |
...
| Duration | Total Invested | Estimated Corpus | Wealth Created by Compounding |
|----------|---------------|-----------------|-------------------------------|
